<?php
    class Cliente{
        ...
        //Función para sacar lista de clientes y sus nif asociados a cada cliente
        public function get_lista(){
            ...
            $lista=[];//Array donce se van a almacenar los datos clave-nif valor- nombre

            while($cons->fetch()){//Mientras se sigan sacando datos
                $lista[$this->nif]=$this->nombre;//Se meten dentro del array formato clave-valor
            }
    ...
    class Producto{
        ...
        //Función para obtener una lista de los productos y su id (los necesitaremos para el select)
        public function get_lista(){
            ...
            $lista=[];//Array donde almacenar clave - cod valor - descripcion

            while($cons->fetch()){//Mientras se sigan sacando datos, se meten en el array
