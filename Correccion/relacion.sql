...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-12-2024 a las 10:40:41
...
('12345676D', 'Eri3', 25, 'Eri3', 'Eri3'),
('12345678D', 'Erica', 25, 'Eri', 'Eri'),
('12345679D', 'Erica2', 25, 'Eri2', 'Eri2'),
...
--
ALTER TABLE `venta`
  ADD CONSTRAINT `fk_cli_vent` FOREIGN KEY (`cliente`) REFERENCES `cliente` (`nif`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_prod_vent` FOREIGN KEY (`producto`) REFERENCES `producto` (`cod`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
